...
description: Deep dive into Chebyshev spectral graph convolutions and analysis using the NEIGHBORSMATCH problem
tags: Graph_learning  
...
Filtering operations are also defined in the frequency domain. Now following the notation from <span class="citation" data-preview="Defferrard, M., Bresson, X., & Vandergheynst, P. (2016). Convolutional Neural Networks on Graphs with Fast Localized Spectral Filtering. NeurIPS.">(Defferrard et al., 2016)</span>, the convolution operation between two signals $$x$$ and $$y$$ on graph $$G$$ is defined as:
...
<figure class="figure-numbered">
    ...
    <figcaption>Visualization of a single graph with depth 4.</figcaption>
</figure>
...
<figure class="figure-numbered">
    ...
    <figcaption>Performance heatmap with different depth and K values.</figcaption>
</figure>
...
<figure class="figure-numbered">
    ...
    <figcaption>Performance heatmap with different depths and the number of layers (K=2).</figcaption>
</figure>
...
<figure class="figure-numbered">
    ...
    <figcaption>Performance heatmap with different depths and number of layers (K=3).</figcaption>
</figure>
